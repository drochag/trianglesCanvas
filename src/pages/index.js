...
trianglesCanvas({
  ...
  refreshTime = 50 // time in ms to draw each set of triangles
      ...
      <p>An npm module to have a background with animated triangles using canvas. Recomputes the gradient while resizing.</p>
...
Triangles({ id: 'trianglesSquares2', size: 40 })`}
      ...
      <p>You can specify starting color or ending color for the background.</p>
      <SyntaxHighlighter style={docco} language="javascript">
        {`Triangles({ id: 'triangles2', dark: 200, light: 220 })`}
      </SyntaxHighlighter>
      <div style={{width: '100%', height: 400}}>
